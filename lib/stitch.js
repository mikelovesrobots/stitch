(function() {
  var CoffeeScript, Package, async, compilers, eco, extname, fs, jade, join, nodePath, normalize, _, _ref,
  ...
  exports.Package = Package = (function() {
    ...
    Package.prototype.getRelativePath = function(path, callback) {
      var base, expandedPath, localPath, resolvedPath, _i, _len, _ref2;
      ...
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        ...
        base = expandedPath + "/";
        if (resolvedPath.indexOf(base) === 0) {
